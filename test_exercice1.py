...
class TestCardsExercice1(unittest.TestCase):
    def test_card_constructor(self):
        self.assertTrue(isinstance(models.Card('as', 'coeur'), models.Card))

    def test_cards_equal_value(self):
        ace_of_hearts = models.Card('as', 'coeur')
        ace_of_spades = models.Card('as', 'coeur')
    ...
    def test_cards_comparison(self):
        ace_of_hearts = models.Card('as', 'coeur')
        two_of_hearts = models.Card('2', 'coeur')
        five_of_hearts = models.Card('5', 'coeur')
